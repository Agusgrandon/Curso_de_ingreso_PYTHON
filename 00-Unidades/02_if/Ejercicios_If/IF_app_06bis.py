...
determinar la posición del jugador en la cancha, considerando los siguientes parametros:
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        tu_altura = float(altura)

        if tu_altura < 1.60 :
            alert("Titulo", "Base")
        elif tu_altura >= 1.60 and tu_altura <= 1.79 :
            alert("Titulo", "Escolta")
        elif tu_altura >= 1.80 and tu_altura <= 1.99 :
            alert("Titulo", "Alero")
        else :
            alert("Titulo", "Ala-Pívot" )
